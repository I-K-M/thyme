...
<main class="site-content">
    <div class="container">
        ...
        <section class="hero box">
            ...
            <p>a high-performance & security seo-friendly minimalist WordPress theme</p>
            <a href="<?php echo get_permalink(get_option('page_for_posts')); ?>" class="btn">see posts</a>
        </section>
        ...
        <section class="faq">
            ...
            <div class="faq-container">
                <div class="faq-item">
                    <button class="faq-question">why is this theme so great?</button>
                ...
                <div class="faq-item">
                    <button class="faq-question">is this theme compatible with major plugins?</button>
                    <div class="faq-answer">
                        <p>yes, thyme works seamlessly with popular plugins like elementor, woocommerce, and yoast seo.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <button class="faq-question">does this theme require coding knowledge?</button>
                    <div class="faq-answer">
                        <p>yes. everything can be customised easily if you know some code.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <button class="faq-question">how secure is this theme?</button>
                    <div class="faq-answer">
